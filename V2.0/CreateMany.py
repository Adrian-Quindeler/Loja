...
class CreateMany:
    ...
    def itemDetails(parent):
        ...
        ssd_details.clicked.connect        (lambda: parent.productDetails("ssd", "",
                                                                          ""))

        cooler_details.clicked.connect     (lambda: parent.productDetails("cooler", "",
                                                                          ""))

        placaVideo_details.clicked.connect (lambda: parent.productDetails("placaVideo", "",
                                                                          ""))
